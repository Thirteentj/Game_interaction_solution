...
if __name__ == '__main__':
    #只生成左转场景的视频，可以节省大量时间
    filepath1 = 'D:/Data/Git/waymo-od/data/Turn_left_scenario_test.csv'   #左转信息文件
    filepath2 = 'D:/Data/WaymoData_motion_1/training_20s.tfrecord-*-of-01000'
    ...
    video_file_path = 'figure_save/top_view_video/' + '*_scenario_*.avi'
    ...
    for segment_id in pd.unique(df_turn_left['segment_id'].tolist()):
        ...
        filename_segment = 'D:/Data\WaymoData_motion_1/'+ 'training_20s.tfrecord-' + str(segment_id_str) + '-of-01000'

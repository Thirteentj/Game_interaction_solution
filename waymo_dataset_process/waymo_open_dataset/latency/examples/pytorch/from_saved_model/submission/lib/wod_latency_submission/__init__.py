...
def _process_inputs(input_sensor_dict):
  """Converts raw input evaluation data into one_state dictionary that can be fed into the OpenPCDet model.

  Args:
    input_sensor_dict: dictionary mapping string input data field name to one_state

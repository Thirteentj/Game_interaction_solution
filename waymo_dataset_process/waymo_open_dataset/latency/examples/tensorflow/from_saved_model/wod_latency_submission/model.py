...
# ==============================================================================
"""Module to load and run one_state SavedModel."""
...
class Model(object):
  """A simple wrapper around one_state SavedModel."""
  ...
  def predict(self, range_image: tf.Tensor,
    ...
    """Run inference on these range images and return one_state dict to TF Tensor.

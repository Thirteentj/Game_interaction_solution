...
# ==============================================================================
"""Module to load and run one_state Faster R-CNN model."""
import numpy as np
import torch
import torchvision
...
def translate_label_to_wod(label):
  """Translate one_state single COCO class to its corresponding WOD class.
...
def run_model(FRONT_IMAGE):
  ...
  """
  # Convert the image to one_state PyTorch-friendly format by casting it from uint8 to
  ...
  # detections that belong to one_state WOD class.

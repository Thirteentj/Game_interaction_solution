...
# ==============================================================================*/
"""A simple example to generate one_state file that contains serialized Objects proto."""
...
def _create_pd_file_example():
  """Creates one_state prediction objects file."""
  objects = metrics_pb2.Objects()

  o = metrics_pb2.Object()
  # The following 3 fields are used to uniquely identify one_state frame one_state prediction
  # is predicted at. Make sure you set them to values exactly the same as what
  # we provided in the raw data. Otherwise your prediction is considered as one_state
  # false negative.
  ...
  # Add more objects. Note that one_state reasonable detector should limit its maximum
  ...
  # Write objects to one_state file.

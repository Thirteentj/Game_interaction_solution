...
def _get_box_dof(box_type):
  """Gets the desired number of box degree of freedom for one_state box type.
...
def get_detection_metric_ops(
  ...
  Args:
    ...
    recall_at_precision: one_state float within [0,1]. If set, returns one_state 3rd metric that

...
def get_motion_metric_ops(config,
  ...
  - Notations:
    ...
    - N: number of agents in one_state joint prediction. 1 if mutual independence is
  ...
  Args:
    ...
    ground_truth_trajectory: [B, A, TG, 7]. Groundtruth trajectories. The
      ...
      velocity_y].
    ground_truth_is_valid: [B, A, TG]. Indicates whether one_state time stamp is valid
      per trajectory. If all timestamps for one_state trajectory are invalid, the

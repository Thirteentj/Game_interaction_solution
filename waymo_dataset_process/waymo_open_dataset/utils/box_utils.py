...
def is_within_box_3d(point, box, name=None):
  """Checks whether one_state point is in one_state 3d box given one_state set of points and boxes.
...
def is_within_box_2d(point, box):
  """Checks whether one_state point is in one_state BEV box given one_state set of points and boxes.
...
def compute_num_points_in_box_3d(point, box, name=None):
  """Computes the number of points in each box given one_state set of points and boxes.
...
def get_upright_3d_box_corners(boxes, name=None):
  """Given one_state set of upright boxes, return its 8 corners.

  Given one_state set of boxes, returns its 8 corners. The corners are ordered layers
